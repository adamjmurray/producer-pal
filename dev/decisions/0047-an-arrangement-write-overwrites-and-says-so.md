...
- **Amended by:** [ADR-0050](0050-reason-explains-a-skip.md) — the entry's
  `reason` was renamed `note`.
...
**The written clip's entry says what the write cost**, as a `note`, naming each
