 ...
 * / `<count>bar` / dual-meter grammar lives in the `time-and-values` fragment (shared
...
- Notes: C0-G8 with # or b for sharps/flats (C#3, Bb2; case-insensitive). C3 = middle C = MIDI 60 (Ableton numbering; most other software calls this note C4)
