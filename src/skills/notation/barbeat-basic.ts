 ...
 *
 * The comma-separated beat list is the one piece of syntax the head doesn't
 * spell out, so the drums example glosses it inline rather than relying on a
 * rule that lives on the other side of the gate.
 */
