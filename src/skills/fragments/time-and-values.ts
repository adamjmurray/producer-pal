...
- \`<count>bar\` is also valid as a **note duration** — meter-aware, so \`1bar\` holds one whole bar in any meter (6 grid beats in 6/8, 5 in 5/4). Bars use the bare \`<count>bar\` form (e.g. \`4bar\`)
