...
- **Drums** — \`kick: X.X. ....\` Each character is one 16th-note step (positional grid): \`^\`=accent, \`X\`=normal, \`x\`=soft, \`.\`=rest. Whitespace groups visually and \`|\` is a visual barline — neither advances time. Drum names: kick snare hihat open tom1 tom2 tom3 ride crash clap rimshot. A pad with no name uses an absolute pitch-name header instead (\`C3: X...\`, Ableton C3=60) — same content syntax.
