...
repeat(2, 1bar)                  // echo every note one bar later (does not resize the clip)
repeat(4, n/8)                   // 4-hit 8th-note echo (original + 3 copies)
