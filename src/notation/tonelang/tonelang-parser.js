...
function peg$parse(input, options) {
  ...
  const peg$e5 = peg$literalExpectation("n", false);
  const peg$e6 = peg$literalExpectation("t", false);
  ...
  const peg$e21 = peg$literalExpectation("B#", false);
  const peg$e22 = peg$literalExpectation("Cb", false);
  ...
  function peg$f2(elements, modifiers, repeater) {
    const grouping = { 
      type: "grouping", 
      content: elements,
      ...modifiers
  ...
  function peg$f7(count) {
    return count;
  }
  function peg$f8(pitch, modifiers, repeater) {
    const noteObj = { 
      type: "note", 
      pitch: pitch.pitch,
      name: pitch.name,
  ...
  function peg$f9(head, tail, modifiers, repeater) {
    const chord = { 
      type: "chord", 
  ...
  function peg$f10(value, repeater) {
    const rest = { 
      type: "rest", 
      duration: value
    };    
  ...
  function peg$f15() {    return Number.parseInt(text());  }
  function peg$f16() {    return Number.parseInt(text());  }
  ...
  function peg$parsetimeUntilNextMod() {
    let s0, s1, s2;
