...
function peg$parse(input, options) {
  ...
  function peg$f18(sign, value) {
    return sign ? -value : value;
  }
  function peg$f19() {
    return Number.parseFloat(text());
  }
  function peg$f20(whole, frac) {
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s2 !== peg$FAILED) {
        ...
        if (s3 !== peg$FAILED) {
          ...
          if (s4 !== peg$FAILED) {
            s5 = peg$parseunsignedFloatOrFraction();
            if (s5 !== peg$FAILED) {
              peg$savedPos = s0;
              s0 = peg$f8(s1, s3, s5);
            } else {
