...
import { updateDrumPadSoloStates } from "../drum-pads-from-chains.ts";
...
import {
  ...
  readMacroVariations,
  readABCompare,
} from "../device-reading.ts";
import { computeState, deviceHasInstrument } from "../chain-info.ts";
