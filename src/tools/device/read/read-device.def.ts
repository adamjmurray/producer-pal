...
export const toolDefReadDevice = defineTool("ppal-read-device", {
  ...
  smallModelModeConfig: {
    ...
    descriptionOverrides: {
      include:
        "chains = rack contents (use maxDepth). params, param-values = parameters. drum-map = note names. sample = Simpler sample file path. actions = device actions. options = device catalogs",
      maxDepth:
