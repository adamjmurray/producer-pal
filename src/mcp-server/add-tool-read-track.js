...
export function addToolReadTrack(server, callLiveApi) {
  server.tool(
    "read-track",
    "Read comprehensive information about a track. Returns sessionClips and arrangerClips arrays containing clip objects with time-based properties in bar:beat format.",
    {
