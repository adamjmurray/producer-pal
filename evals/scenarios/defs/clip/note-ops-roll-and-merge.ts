...
/**
 * Note-count transform idioms: does the model reach for ratchet()/split()/
 * merge() — the statement-level note-count operations — rather than
 ...
 * `./scripts/eval -m google/gemini-3.5-flash -t note-ops-ratchet-roll -t note-ops-merge -t note-ops-split -t note-ops-split-sync`.
