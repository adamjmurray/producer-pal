...
| `plugins-and-max-devices`                        | Loading VST/AU plug-ins, Max for Live devices and presets, sent only while the Producer Pal [remote script](/guide/remote-script) is running |
