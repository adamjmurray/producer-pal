...
// dev/quality/Testing.md); mutating one is meaningless. Keep them
...
const TOOL_DOMAIN_BREAKS = {
  track: 85, // triaged 2026-07-14 at 86.15% (see dev/quality/mutation-testing/baselines/track.md)
  session: 89, // triaged 2026-07-14 at 90.46% (see dev/quality/mutation-testing/baselines/session.md)
  actions: 90, // triaged 2026-07-15 at 91.79% (see dev/quality/mutation-testing/baselines/actions.md)
  device: 90, // triaged 2026-07-15 at 91.18% (see dev/quality/mutation-testing/baselines/device.md)
  clip: 96, // triaged 2026-07-15 at 97.48% (see dev/quality/mutation-testing/baselines/clip.md)
  advanced: 97, // triaged 2026-07-15 at 98.60% (see dev/quality/mutation-testing/baselines/read-op-tier.md)
  core: 99, // triaged 2026-07-15 at 100.00% (see dev/quality/mutation-testing/baselines/read-op-tier.md)
  scene: 96, // triaged 2026-07-15 at 97.66% (see dev/quality/mutation-testing/baselines/read-op-tier.md)
  "live-set": 98, // triaged 2026-07-15 at 99.07% (see dev/quality/mutation-testing/baselines/read-op-tier.md)
  shared: 94, // triaged 2026-07-16 at 95.25% (see dev/quality/mutation-testing/baselines/shared.md)
};
...
// defensive / static-init mutants (see dev/quality/mutation-testing/baselines/shared-runtime.md).
...
// the perTest guard-attribution quirk (see dev/quality/mutation-testing/baselines/mcp-server.md).
...
// mutants (see dev/quality/mutation-testing/baselines/v8-adapter.md).
